...
git remote add github https://$GITHUB_TOKEN@github.com/starhao/kato-menu.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/starhao/kato-menu/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "kato-menu更新", "text": "@所有人\n# [kato-menu('$version')]('$html_url')\n'$body'"}}'
